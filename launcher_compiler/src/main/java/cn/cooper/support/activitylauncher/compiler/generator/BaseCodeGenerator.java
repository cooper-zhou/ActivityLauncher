...
public abstract class BaseCodeGenerator implements CodeGenerator {
    ...
    List<ActivityResultModel> mActivityResultMethods = new ArrayList<>();
    ...
    @Override
    public boolean putActivityResultElement(ExecutableElement element) {
        return mActivityResultMethods.add(new ActivityResultModel(element));
    }
